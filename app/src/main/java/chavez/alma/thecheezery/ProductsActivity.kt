...
class ProductsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var adaptador: AdaptadorProducto?

        when (id) {
            0 -> adaptador = AdaptadorProducto(this, coldDrinks)
            1 -> adaptador = AdaptadorProducto(this, hotDrinks)
            2 -> adaptador = AdaptadorProducto(this, sweets)
            3 -> adaptador = AdaptadorProducto(this, salties)
...
*/
  //  var adaptador =AdaptadorProducto(this,coldDrinks)


    fun agregarProductos(id:Int){
        when(id){
            0->{
    ...
    public class AdaptadorProducto: BaseAdapter{
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var vista = inflator.inflate(R.layout.activity_products,null)
